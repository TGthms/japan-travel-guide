...
(function (global) {
  ...
  global.JTG.TRANSLATIONS = {
    ...
    "common": {
      ...
      "filterEmptyTitle": "No photos in this view",
      "filterEmptyDesc": "Try another category, city, or search. The library itself is not empty.",
    ...
    "budget": {
      ...
      "desc": "Realistic Japan trip cost estimate from daily rates, rail, transfers, and a buffer. Planning figures only—not a quote.",
      "days": "Days in Japan",
      ...
      "foodMid": "Restaurant mix",
      "foodGourmet": "Gourmet",
      "attractions": "Sights & activities",
      "attrLight": "Light",
      "attrStandard": "Standard",
      "attrHeavy": "Ticket-heavy",
      "currency": "Currency",
      ...
      "sectionDaily": "Daily style",
      "sectionOnce": "Travel add-ons",
      ...
      "ryokan": "Ryokan / boutique",
      "rooms": "Rooms",
      "pass": "Metro day-pass mix",
      "active": "Active city-hopping",
      "taxi": "Taxi-heavy",
      "foodNice": "Nice dinners",
      "railLegs": "Long-distance legs",
      "railLegsHint": "e.g. Tokyo→Kyoto and return = 2. Updates when you change city count.",
      "railStyle": "Long-distance style",
      "railShinkansen": "Shinkansen",
      "railHighway": "Bus / slower rail",
      "railPass": "JR Pass style",
      "railFlight": "Domestic flights",
      "airport": "Airport transfers",
      "airportTrain": "Train / bus",
      "airportExpress": "Airport express",
      "airportTaxi": "Taxi / private",
      "sim": "Phone data",
      "simNone": "Wi‑Fi only",
      "simEsim": "eSIM / pocket Wi‑Fi",
      "simPremium": "High-data eSIM",
      "buffer": "Contingency",
      "buffer5": "5%",
      ...
      "disclaimer": "Indicative averages for independent travelers. Hotel peaks and premium rail can run higher—confirm before booking.",
      "breakdownTitle": "Breakdown",
      "tipsTitle": "Tips for this plan"
    },
    "packing": {
      "eyebrow": "Prepare",
    ...
    "gallery": {
      ...
      "heading": "Moments from <em>Japan</em>",
    ...
    "tools": {
      ...
      "intro": "Open a tool to plan a Japan trip — weather, budget, packing, currency, clocks, tax, rail, and emergency numbers.",
      "railHubLabel": "Rail planner",
      "railHubSub": "JR Pass sense-check and shinkansen fare estimates.",
    ...
    "cityPage": {
      ...
      "switchCity": "Switch city"
        ...
        "weather": {
      "search": "Search city",
      "searchPlaceholder": "Search Japan or world cities…",
      "refresh": "Refresh",
      "updated": "Updated",
      ...
      "alertSource": "Open-Meteo",
      "loadingHint": "Loading cities…",
      "loadingAlerts": "Checking alerts…",
      "loadingDone": "Ready",
      "emptySearch": "No cities found.",
    ...
    "common": {
      ...
      "filterEmptyTitle": "この表示に写真がありません",
      "filterEmptyDesc": "別のカテゴリ・都市・検索を試してください。ライブラリ自体は空ではありません。",
      "settingsTitle": "設定",
      "language": "言語",
      "distanceUnit": "距離",
      "tempUnit": "気温",
    ...
    "budget": {
      "eyebrow": "費用",
      "title": "予算プランナー",
      "desc": "日額・長距離移動・空港アクセス・通信・予備費から現実的な旅費目安を算出。計画用で、確定料金ではありません。",
      "days": "滞在日数",
      "accommodation": "宿泊",
      "hostel": "ホステル／カプセル",
      "business": "ビジネスホテル",
      ...
      "airport": "空港アクセス",
      "airportTrain": "電車／バス",
      "airportExpress": "エアポート特急",
      "airportTaxi": "タクシー",
      "sim": "通信",
      "simNone": "Wi‑Fiのみ",
      "simEsim": "eSIM／ポケットWi‑Fi",
      "simPremium": "大容量eSIM",
      "buffer": "予備費",
      "buffer5": "5%",
      "buffer10": "10% おすすめ",
      ...
      "disclaimer": "個人旅行向けの目安です。繁忙期の宿や特急は上振れします。予約前に公式確認を。",
      "breakdownTitle": "内訳",
      "tipsTitle": "このプランへのヒント"
    },
    "packing": {
      "eyebrow": "荷物",
      "title": "パッキングリスト",
    ...
    "tools": {
      ...
      "intro": "天気、予算、荷物、為替、時計、税、鉄道、緊急電話 — カードを開いて使います。",
      "railHubLabel": "鉄道プランナー",
      "railHubSub": "JRパスの目安と新幹線運賃の概算。",
    ...
    "cityPage": {
      ...
      "switchCity": "都市を切り替え"
        ...
        "weather": {
      "search": "都市を検索",
      "searchPlaceholder": "日本や世界の都市を検索…",
      "refresh": "更新",
      "updated": "更新時刻",
      "useLocation": "現在地を使う",
      "locating": "位置情報を取得中…",
      "loading": "読み込み中…",
      "loadingForecasts": "予報を読み込み中…",
      ...
      "close": "閉じる",
      "done": "完了",
      "attribution": "データ: Open-Meteo（CC BY 4.0）。目安であり緊急時には使えません。",
      "alert": "警報",
      "alerts": "気象警報",
      "alertUntil": "{time} まで",
      "alertSource": "Open-Meteo",
      "loadingHint": "都市を読み込み中…",
      "loadingAlerts": "警報を確認中…",
      "loadingDone": "完了",
      "emptySearch": "都市が見つかりません。",
      "majorCities": "主要都市",
      "favorites": "お気に入り",
      "myLocation": "現在地"
    },
    ...
    "common": {
      ...
      "filterEmptyTitle": "此视图没有照片",
      "filterEmptyDesc": "试试其他分类、城市或搜索。图库本身不是空的。",
      "settingsTitle": "设置",
      "language": "语言",
      "distanceUnit": "距离单位",
      "tempUnit": "温度单位",
    ...
    "budget": {
      "eyebrow": "花费",
      "title": "预算规划器",
      "desc": "按日均花费、长途交通、机场接驳、上网与缓冲估算行程费用。仅供规划，非报价。",
      "days": "在日天数",
      "accommodation": "住宿",
      "hostel": "青旅／胶囊",
      "business": "商务酒店",
      ...
      "disclaimer": "自由行参考区间。旺季酒店与特急可能更高，预订前请再确认。",
      "breakdownTitle": "明细",
      "tipsTitle": "针对本方案的提示"
    },
    "packing": {
    ...
    "tools": {
      ...
      "intro": "打开一张卡片即可使用天气、预算、行李、汇率、时钟、税费、铁路与紧急电话。",
      "railHubLabel": "铁路规划",
      "railHubSub": "JR Pass 粗算与新干线票价估算。",
    ...
    "cityPage": {
      ...
      "switchCity": "切换城市"
        ...
        "weather": {
      "search": "搜索城市",
      "searchPlaceholder": "搜索日本或世界城市…",
      "refresh": "刷新",
      "updated": "已更新",
      "useLocation": "使用我的位置",
      "locating": "正在获取位置…",
      "loading": "加载中…",
      "loadingForecasts": "正在加载预报…",
      "error": "无法加载天气数据。",
      "retry": "重试",
      "high": "最高",
      "low": "最低",
      ...
      "close": "关闭",
      "done": "完成",
      "attribution": "数据来源：Open-Meteo（CC BY 4.0）。仅供参考，请勿用于紧急决策。",
      "alert": "预警",
      "alerts": "天气预警",
      "alertUntil": "至 {time}",
      "alertSource": "Open-Meteo",
      "loadingHint": "正在加载城市…",
      "loadingAlerts": "正在检查预警…",
      "loadingDone": "就绪",
      "emptySearch": "未找到城市。",
      "majorCities": "主要城市",
      "favorites": "收藏",
